...
topic_path_change = publisher.topic_path("essential-tower-422709-k9", "change-audiobook")
topic_path_delete = publisher.topic_path("essential-tower-422709-k9", "delete-audiobook")
