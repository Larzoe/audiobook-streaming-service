...
topic_path_change = publisher.topic_path(
    "essential-tower-422709-k9", "update-audiobook-catalog"
)
topic_path_delete = publisher.topic_path(
    "essential-tower-422709-k9", "delete-audiobook-catalog"
)
topic_path_add = publisher.topic_path("essential-tower-422709-k9", "create-audiobook-catalog")
